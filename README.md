...
To get up and running either [click this link](https://runme.dev/api/runme?repository=https%3A%2F%2Fgithub.com%2Fchristian-bromann%2Fvue-enterprise-boilerplate.git&fileToOpen=README.md) or clone the project manually. Then run:
